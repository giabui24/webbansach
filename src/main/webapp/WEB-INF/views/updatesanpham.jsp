                      ...
                      <form id="form-sanpham" role="form">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            <div id="masanpham" data-value="${sanpham.getMasanpham() }" class="input-group-prepend">
                              <span class="input-group-text"><i class="fa fa-list"></i></span>
                            </div>
                            <input name="tensanpham" type="text" class="form-control" value="${sanpham.getTensanpham() }">
                          </div>
                          <!-- /.input group -->
                        </div>
                         <div class="form-group">
                        ...
                        <div id="chitietsanpham">
                         ...
                         <c:forEach var="chitietsanpham" items="${sanpham.getDanhsachchiTietSanPham()}">
                          ...
                          <div class="input-group">
                            ...
                            <input  name="soluong" type="number" class="form-control" value="${chitietsanpham.getSoluong() }">
                          </div>
                          <!-- /.input group -->
                        </div>
                        ...
                        <!-- phone mask -->
                          ...
                          <div class="input-group">
                            ...
                            <input name="giatien" type="text" class="form-control" value="${sanpham.getGiatien()}">
                          </div>
                          <!-- /.input group -->
                        </div>
                        <!-- /.form group -->
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                           <div class="input-group-prepend">
                            <div class="mb-3">
                                  <textarea  name="mota" class="textarea" 
                                            style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid rgb(221, 221, 221); padding: 10px; display: none;">${sanpham.getMota()}</textarea>
                            </div>
                            </div>
                          </div>
                          <!-- /.input group -->
                        ...
                        <div class="form-group">
                          <div class="input-group justify-content-center">
                            <a href="#">
                              <button id="btncapnhatsanpham" type="button" class="btn btn-success text-right">
